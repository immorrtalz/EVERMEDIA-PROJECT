window.addEventListener("load", (event) => {
	...
	$('<a class="extra-link-icon" href="https://www.youtube.com/c/EVERESTSTUDIOProject"><img src="images/socials/yt.png"></a>').appendTo(elm);
	$('<a class="extra-link-icon" href="https://discord.gg/GbzYVdF"><img src="images/socials/ds.png"></a>').appendTo(elm);
	$('<a class="extra-link-icon" href="https://t.me/everest_studio_project"><img src="images/socials/tg_channel.png"></a>').appendTo(elm);
	$('<a class="extra-link-icon" href="https://t.me/everest_studio_project_cm"><img src="images/socials/tg_chat.png"></a>').appendTo(elm);
	$('<a class="extra-link-icon" href="https://vk.com/everest_studio_project"><img src="images/socials/vk.png"></a>').appendTo(elm);
